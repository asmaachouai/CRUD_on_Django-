...
def write_learners():
    ...
    # Add more learners
    learner_susan = Learner(first_name='Susan', last_name='Johnson', dob=date(1995, 9, 20),
                            occupation='student',
                            social_link='https://www.linkedin.com/susan/')
    learner_susan.save()
    
    learner_michael = Learner(first_name='Michael', last_name='Brown', dob=date(1989, 11, 5),
                              occupation='engineer',
